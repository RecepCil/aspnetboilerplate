...
namespace AspNetBoilerPlate.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = AspNetBoilerPlateConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(AspNetBoilerPlateDbContext context)
        {
            _context = context;
        }
