...
namespace AspNetBoilerPlate.Controllers
{
    ...
    public class TokenAuthController : AspNetBoilerPlateControllerBase
    {
        ...
        {
            return SimpleStringCipher.Instance.Encrypt(accessToken, AspNetBoilerPlateConsts.DefaultPassPhrase);
        }
    }
}
